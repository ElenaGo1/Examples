...
*/
//==Собрать строку с числами при a <= b в обратном порядке
/*
string NumbersFor(int a, int b)
{
    string result = String.Empty;
...
*/
//Вычислить а^n возвести a в степень n
/*
...
//== Обход папок файлов
/*
string path = "/Users/Dima/Desktop/Examples/Example013_arrays_ordering";
...
string path  = @"/Users/Dima/Desktop/Examples";
CatalogInfo(path);
*/
...
string [] tree = {emp,"/","*","10","-","+",emp,emp, "4", "2", "l", "3" };
...
InOrderTraversal();
*/
// === Наглядно как тормозит рекурсия
/*
decimal fRec = 0; 
decimal fIte = 0; 
...
//========масиумум заполяняет квадрат 100 на 100 и меньше
/*
